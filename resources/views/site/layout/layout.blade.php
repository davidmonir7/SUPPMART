...
<html lang="en">
    ...
    <link rel="stylesheet" href="{{ asset('dashboard') }}/assets/site/css/bootstrap.min.css">
  
    <link rel="stylesheet" href="{{ asset('dashboard') }}/assets/site/css/all.min.css">
    <link rel="stylesheet" href="{{ asset('dashboard') }}/assets/site/css/all.min.css">
    <link rel="stylesheet" href="{{ asset('dashboard') }}/assets/site/css/supp.css">
