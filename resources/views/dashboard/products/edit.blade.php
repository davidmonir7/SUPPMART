                                ...
                                <form action="{{ route('dashboard.products.update', $product->id) }}" method="post"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            <label for="validationCustomtitle" class="col-form-label pt-0">categories</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="validationCustom02" type="text" value="{{$product->quantity}}"
                                                name="discount_price">
                                        </div>
